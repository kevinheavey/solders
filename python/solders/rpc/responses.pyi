...
class BlockNotificationResult:
    context: RpcResponseContext
    value: UiConfirmedBlock
    def __init__(
        self, value: UiConfirmedBlock, context: RpcResponseContext
    ) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
...
class SlotNotificationResult:
    context: RpcResponseContext
    value: SlotInfo
    def __init__(self, value: SlotInfo, context: RpcResponseContext) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> SlotNotificationResult: ...
    @staticmethod
    def from_bytes(data: bytes) -> SlotNotificationResult: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class SlotNotification:
    ...
    subscription: int
    def __init__(self, result: SlotNotificationResult, subscription: int) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> SlotNotification: ...
    @staticmethod
    def from_bytes(data: bytes) -> SlotNotification: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class SlotUpdateNotificationResult:
    context: RpcResponseContext
    value: SlotUpdate
    def __init__(self, value: SlotUpdate, context: RpcResponseContext) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> SlotUpdateNotificationResult: ...
    @staticmethod
    def from_bytes(data: bytes) -> SlotUpdateNotificationResult: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class SlotUpdateNotification:
    result: SlotUpdateNotificationResult
    subscription: int
    def __init__(
        self, result: SlotUpdateNotificationResult, subscription: int
    ) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
...
class RootNotificationResult:
    context: RpcResponseContext
    value: int
    def __init__(self, value: int, context: RpcResponseContext) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RootNotificationResult: ...
    @staticmethod
    def from_bytes(data: bytes) -> RootNotificationResult: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RootNotification:
    result: RootNotificationResult
    subscription: int
    def __init__(self, result: RootNotificationResult, subscription: int) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
...
class VoteNotificationResult:
    context: RpcResponseContext
    value: RpcVote
    def __init__(self, value: RpcVote, context: RpcResponseContext) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> VoteNotificationResult: ...
    @staticmethod
    def from_bytes(data: bytes) -> VoteNotificationResult: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RooVoteNotification:
    result: VoteNotificationResult
    subscription: int
    def __init__(self, result: VoteNotificationResult, subscription: int) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RooVoteNotification: ...
    @staticmethod
    def from_bytes(data: bytes) -> RooVoteNotification: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
