...
class Rent:
    ...
    def __init__(self, burn_percent: int, exemption_threshold: float, lamports_per_byte_year: int) -> None: ...
    def calculate_burn(self, rent_collected: int) -> Tuple[int, int]: ...
    @staticmethod
    def default(self) -> "Rent": ...
    def due(self, balance: int, data_len: int, years_elapsed: float) -> Optional[int]: ...
