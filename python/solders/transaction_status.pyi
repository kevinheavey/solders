...
class UiPartiallyDecodedInstruction:
    ...
    def __eq__(
        self,
        other: "UiPartiallyDecodedInstruction",
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class UiTransactionTokenBalance:
    ...
    def __eq__(
        self,
        other: "UiTransactionTokenBalance",
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class EncodedTransactionWithStatusMeta:
    ...
    def __eq__(
        self,
        other: "EncodedTransactionWithStatusMeta",
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class TransactionErrorInstructionError:
    ...
    def __eq__(
        self,
        other: "TransactionErrorInstructionError",
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class TransactionErrorDuplicateInstruction:
    ...
    def __eq__(
        self,
        other: "TransactionErrorDuplicateInstruction",
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class TransactionErrorInsufficientFundsForRent:
    ...
    def __eq__(
        self,
        other: "TransactionErrorInsufficientFundsForRent",
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
