...
class UiParsedMessage:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "UiParsedMessage", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class UiTransaction:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "UiTransaction", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class UiInnerInstructions:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "UiInnerInstructions", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class UiLoadedAddresses:
    def __init__(writable: Sequence[Pubkey], readonly: Sequence[Pubkey]) -> None: ...
    @property
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "UiLoadedAddresses", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class UiTransactionTokenBalance:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "UiTransactionTokenBalance", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class TransactionReturnData:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "TransactionReturnData", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class UiTransactionStatusMeta:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "UiTransactionStatusMeta", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class EncodedTransactionWithStatusMeta:
    ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(
        self, other: "EncodedTransactionWithStatusMeta", op: int
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class InstructionErrorCustom:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "InstructionErrorCustom", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class InstructionErrorBorshIO:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "InstructionErrorBorshIO", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class TransactionErrorInstructionError:
    ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(
        self, other: "TransactionErrorInstructionError", op: int
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class TransactionErrorDuplicateInstruction:
    ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(
        self, other: "TransactionErrorDuplicateInstruction", op: int
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class TransactionErrorInsufficientFundsForRent:
    ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(
        self, other: "TransactionErrorInsufficientFundsForRent", op: int
    ) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
...
class Reward:
    ...
    def __repr__(self) -> str: ...
    def __bytes__(self) -> bytes: ...
    def __richcmp__(self, other: "Reward", op: int) -> bool: ...
    def __hash__(self) -> int: ...
    @staticmethod
